                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center flex-wrap">
                                                ...
                                                <div class="ms-3 name flex-fill p-5">
                                                    ...
                                                    <div class="row mb-5">
                                                        <div class="col-md-6">
                                                            <h5 class="font-bold">Nama Usaha :</h5>
                                                            <p class="text-muted mb-0">{{ $user->nama_usaha }}</p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <h5 class="font-bold">Bidang Usaha :</h5>
                                                            <p class="text-muted mb-0">{{ $user->bidang_usaha }}</p>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-5">
                                                        <div class="col-md-12">
                                                            <h5 class="font-bold">Deskripsi Usaha :</h5>
