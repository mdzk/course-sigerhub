                        ...
                        <div class="col-md-6 mt-5">
                            ...
                            <div class="col-auto">
                                <span class="text-muted">
                                    <a class="mt-1 fw-bold" href="">Selengkapnya </a><svg class="ms-1"
                ...
                <div class="col-md-6 col-sm-12 mt-5 d-flex justify-content-start align-items-center">
                    <div class="row">
                        <div class="col-12 pe-5">
                            ...
                            <a href="{{ url('register') }}" class="btn btn-lg btn-warning text-white p-3">Daftar Sekarang,
                                Gratis !</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row d-flex flex-wrap justify-content-between">
                        ...
                        <div class="col-md-4 p-2">
                            <div class="card mb-0 p-4">
                                ...
                                <p class="mt-3">Dapat berkomunikasi langsung dengan para ahli bisnis yang sudah sukses.
                                    Anda
                                ...
                                <div class="col-auto">
                                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="#891B5B" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg><span class="ms-3 mt-1 text-black fw-bold" href="">Jaringan yang
                                        Luas</span>
                                </div>
                                <p class="mt-3">Dalam kelas inkubasi anda akan ditemukan dengan para peserta yang
                                    memiliki
                                    minat
                        ...
                        <div class="col-md-4 p-2">
                            <div class="card mb-0 p-4">
                                <div class="col-auto">
                                    ...
                                    <span class="ms-3 mt-1 text-black fw-bold" href="">Materi Terkini dan
                                        Relevan</span>
                                </div>
                                <p class="mt-3">Materi pada kelas inkbasi dibuat dengan menggunakan materi yang terkini
                                    dan
                        ...
                        <div class="col-md-4 p-2">
                            <div class="card mb-0 p-4">
                                <div class="col-auto">
                                    ...
                                    <span class="ms-3 mt-1 text-black fw-bold" href="">Fleksibilitas & Akses
                                        online</span>
                                </div>
                        ...
                        <div class="col-md-4 p-2">
                            <div class="card mb-0 p-4">
                                <div class="col-auto">
                                    ...
                                    <span class="ms-3 mt-1 text-black fw-bold" href="">Dukungan & Umpan
                                        Balik</span>
                                </div>
                                ...
                                <div class="accordion-item shadow-lg">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Apakah video pembelajaran dapat dilihat berulang ?
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item shadow-lg">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Apakah dapat memilih topik pembelajaran tertentu ?
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item shadow-lg">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Apakah setelah course selesai, akan mendapat sertifikat ?
                                        </button>
                                    </h2>
