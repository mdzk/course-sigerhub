            ...
            <div id="auth-left">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group position-relative has-icon-right mb-5">
                        <input id="name" placeholder="adeline palmerston" type="text"
                    ...
                    <h6>Nama Usaha :</h6>
                    <div class="form-group position-relative has-icon-right mb-5">
                        <input id="nama_usaha" type="text" placeholder="Startup Perikanan"
                            class="form-control form-control-xl @error('nama_usaha') is-invalid @enderror" name="nama_usaha"
                            value="{{ old('nama_usaha') }}" required autocomplete="nama_usaha" autofocus>
                        <div class="form-control-icon">
                    ...
                    <h6>Bidang Usaha :</h6>
                    <div class="form-group position-relative has-icon-right mb-5">
                        <input id="bidang_usaha" type="text" placeholder="Peternakan"
                            class="form-control form-control-xl @error('bidang_usaha') is-invalid @enderror"
                            name="bidang_usaha" value="{{ old('bidang_usaha') }}" required autocomplete="bidang_usaha"
                            autofocus>
                        <div class="form-control-icon">
                    ...
                    <h6>Email :</h6>
                    <div class="form-group position-relative has-icon-right mb-5">
                        <input id="email" type="email" placeholder="adelinepalmers@gmail.com"
                    ...
                    <div class="form-group position-relative has-icon-right mb-5">
                        <textarea placeholder="Usaha saya dibidang..." required name="description" cols="30" rows="5"
                            class="form-control form-control-xl @error('description') is-invalid @enderror">{{ old('nohp') }}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
