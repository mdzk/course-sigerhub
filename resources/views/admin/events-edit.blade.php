                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('event-update', $event->id) }}"
                                    ...
                                    <div class="form-group mb-5">
                                        <input type="text" value="{{ old('title_event', $event->title_event) }}"
                                    ...
                                    <h6>Tanggal:</h6>
                                    <div class="form-group mb-5">
                                        <input type="date" value="{{ old('date', $event->date) }}"
                                    ...
                                    <h6>Waktu:</h6>
                                    <div class="form-group mb-5">
                                        <input type="time" value="{{ old('time', $event->time) }}"
                                    ...
                                    <h6>Tempat:</h6>
                                    <div class="form-group mb-5">
                                        <input type="text" value="{{ old('location', $event->location) }}"
                                    ...
                                    <div class="form-group mb-5">
                                        <input type="text" value="{{ old('link', $event->link) }}"
                                    ...
                                    <div class="form-group mb-5">
                                        <div class="form-check">
                                            <input @if ($event->tipe == 'online') checked @endif class="form-check-input"
                                                type="radio" name="tipe" id="flexRadioDefault1" value="online">
                                        ...
                                        <div class="form-check">
                                            <input @if ($event->tipe == 'offline') checked @endif class="form-check-input"
                                                type="radio" name="tipe" id="flexRadioDefault1" value="offline">
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                Offline
                                            </label>
                                        </div>
                                    ...
                                    <div class="form-group mb-5">
                                        ...
                                        @enderror
                                        <span>* Kosongkan jika tidak ingin mengganti poster</span>
                                    </div>
